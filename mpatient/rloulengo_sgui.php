...
<tr>
<td colspan="2"><label for="tel"> Telefonnummer:</label></td>
<td><input disabled type="text" id="tel" name="tel" size="8" maxlength="30" value="<?php echo $tel; ?>"></td>
</tr>
<tr>
<td colspan="2"><label for="email"> E-mail:</label></td>
<td><input disabled type="text" id="email" name="email" size="20" maxlength="35" value="<?php echo $email; ?>"></td>
</tr>
<tr><td>
Geschlecht: <br>
